...
local function CreateUnitSettings(containerParent, unit)
    ...
    local function SelectUnitTab(SubContainer, _, UnitTab)
        ...
        if UnitTab == "Frame" then
            CreateFrameSettings(SubContainer, unit, UUF.db.profile.Units[unit].Frame.AnchorParent and true or false, function() UpdateMultiFrameUnit(unit, function() UUF:UpdateUnitFrame(UUF[unit:upper()], unit) end) end)
        elseif UnitTab == "HealPrediction" then
            CreateHealPredictionSettings(SubContainer, unit, function() UpdateMultiFrameUnit(unit, function() UUF:UpdateUnitHealPrediction(UUF[unit:upper()], unit) end) end)
        elseif UnitTab == "Auras" then
            CreateAuraSettings(SubContainer, unit)
        elseif UnitTab == "PowerBar" then
            CreatePowerBarSettings(SubContainer, unit, function() UpdateMultiFrameUnit(unit, function() UUF:UpdateUnitPowerBar(UUF[unit:upper()], unit) end) end)
        ...
        elseif UnitTab == "AlternativePowerBar" then
            CreateAlternativePowerBarSettings(SubContainer, unit, function() UpdateMultiFrameUnit(unit, function() UUF:UpdateUnitAlternativePowerBar(UUF[unit:upper()], unit) end) end)
        elseif UnitTab == "CastBar" then
            CreateCastBarSettings(SubContainer, unit)
        elseif UnitTab == "Portrait" then
            CreatePortraitSettings(SubContainer, unit, function() UpdateMultiFrameUnit(unit, function() UUF:UpdateUnitPortrait(UUF[unit:upper()], unit) end) end)
